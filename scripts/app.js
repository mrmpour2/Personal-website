...
const resumeListItems = document.querySelectorAll('.tabmenu__links')
const portfolioListItems = document.querySelectorAll('.portfolio-menu__list')
...
navigationTabsInit(resumeListItems, 'tabmenu__links--active', 'resume-content--show')
navigationTabsInit(portfolioListItems, 'portfolio-menu__list--active', 'portfolio--show')
...
function observerHandler(allSections) {
    allSections.map(section => {
        ...
        let sectionMenuItem = document.querySelector(`.menu__links[data-section=${sectionClassName}]`)
        if (section.isIntersecting){
            sectionMenuItem.classList.add("menu__links--active")
        } else {
            sectionMenuItem.classList.remove("menu__links--active")
        }
    })
}
...
menuItems.forEach(item => {
    item.addEventListener("click", function (e) {
        e.preventDefault()
        removeActiveClass('menu__links--active')
        item.classList.add("menu__links--active")
